...
<!-- 					<form id="expAppfrm" method="post" action="/coco/admin/getTotalReport"> -->
						<h5 class="h5">차단처리</h5>
						<div class="row d-flex my-1">
							...
							<div class="col-sm-3">
								<button class="btn btn-warning" onclick="window.open('/coco/mentoring/mentoringDetail?eprodNum=SLPO2305110001','CoCo-Admin Page','width=1280,height=800,location=no,status=no,scrollbars=yes');">확인</button>
							</div>
						</div>
						...
						<div class="row d-flex my-1">
							...
							<div class="col-sm-8">
								<input type="text" id="" name="" class="form-control text-center" value="10" readonly="readonly">
							</div>
						</div>
